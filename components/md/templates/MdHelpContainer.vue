<template>
  <div class="pt-3">
    <fb-fut-button
      ...
      :class="{active: currentSlug === 'rules' || initialSlug === 'rules'}"
    ...
    <div id="rules" class="collapse mb-2" :class="{ show: initialSlug === 'rules' }">
      ...
      <h5 class="text-dark d-none d-print-block text-center fw-bold">
        {{ $t('i18n_regras_gerais') }}
      </h5>
      <fb-fut-button class="p-2 float-end d-print-none mt-3" primary @click="printPage()">
        <font-awesome-icon class="me-1" :icon="['fas', 'print']" />{{ $t('i18n_imprimir') }}
      </fb-fut-button>
      <fut-html-render text-color :content="getLegalRules" />
    </div>
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'deposits' || initialSlug === 'deposits'}"
      data-bs-toggle="collapse"
    ...
    <div id="deposits" class="collapse mb-2" :class="{ show: initialSlug === 'deposits' }">
      ...
      <fut-html-render text-color :content="getLegalDeposits" />
    </div>
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'responsible' || initialSlug === 'responsible'}"
      data-bs-toggle="collapse"
    ...
    <div id="responsible" class="collapse mb-2" :class="{ show: initialSlug === 'responsible' }">
      ...
      <fut-html-render text-color :content="getLegalResponsible" />
    </div>
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'suport' || initialSlug === 'suport'}"
      data-bs-toggle="collapse"
    ...
    <div id="suport" class="collapse mb-2" :class="{ show: initialSlug === 'suport' }">
      ...
      <fut-html-render text-color :content="getLegalSuport" />
    </div>
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'terms' || initialSlug === 'terms'}"
      data-bs-toggle="collapse"
    ...
    <div id="terms" class="collapse mb-2" :class="{ show: initialSlug === 'terms' }">
      ...
      <fut-html-render text-color :content="getLegalTerms" />
    </div>
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'privacy' || initialSlug === 'privacy'}"
      data-bs-toggle="collapse"
    ...
    <div id="privacy" class="collapse mb-2" :class="{ show: initialSlug === 'privacy' }">
      ...
      <fut-html-render text-color :content="getLegalPrivacy" />
    </div>
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'aml' || initialSlug === 'aml'}"
      data-bs-toggle="collapse"
      data-bs-target="#aml"
    ...
    <div id="aml" class="collapse mb-2" :class="{ show: initialSlug === 'aml' }">
      ...
      <fut-html-render text-color :content="getLegalAml" />
    </div>
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'cookies' || initialSlug === 'cookies'}"
      data-bs-toggle="collapse"
    ...
    <div id="cookies" class="collapse mb-2" :class="{ show: initialSlug === 'cookies' }">
      ...
      <fut-html-render text-color :content="getLegalCookies" />
    </div>
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'faq' || initialSlug === 'faq'}"
      data-bs-toggle="collapse"
      data-bs-target="#faq"
    ...
    <div id="faq" class="collapse mb-2" :class="{ show: initialSlug === 'faq' }">
      ...
      <fut-html-render text-color :content="getLegalFaq" />
    </div>
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'about' || initialSlug === 'about'}"
      data-bs-toggle="collapse"
    ...
    <div id="about" class="collapse mb-2" :class="{ show: initialSlug === 'about' }">
      ...
      <fut-html-render text-color :content="getLegalAbout" />
    </div>
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'affiliates' || initialSlug === 'affiliates'}"
      data-bs-toggle="collapse"
    ...
    <div id="affiliates" class="collapse mb-2" :class="{ show: initialSlug === 'affiliates' }">
      ...
      <fut-html-render text-color :content="getLegalAffiliates" />
    </div>
    <!-- new -->
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'auto_exclusion' || initialSlug === 'auto_exclusion'}"
      data-bs-toggle="collapse"
    ...
    <div id="auto_exclusion" class="collapse mb-2" :class="{ show: initialSlug === 'auto_exclusion' }">
      ...
      <fut-html-render text-color :content="getLegalAutoExclusion" />
    </div>
    <!-- new -->
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'disputs_resolution' || initialSlug === 'disputs_resolution'}"
      data-bs-toggle="collapse"
    ...
    <div id="disputs_resolution" class="collapse mb-2" :class="{ show: initialSlug === 'disputs_resolution' }">
      ...
      <fut-html-render text-color :content="getLegalDisputsResolution" />
    </div>
    <!-- new -->
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'method_impartiality' || initialSlug === 'method_impartiality'}"
      data-bs-toggle="collapse"
    ...
    <div id="method_impartiality" class="collapse mb-2" :class="{ show: initialSlug === 'method_impartiality' }">
      ...
      <fut-html-render text-color :content="getLegalMethodImpartiality" />
    </div>
    <!-- new -->
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'kyc_politcs' || initialSlug === 'kyc_politcs'}"
      data-bs-toggle="collapse"
    ...
    <div id="kyc_politcs" class="collapse mb-2" :class="{ show: initialSlug === 'kyc_politcs' }">
      ...
      <fut-html-render text-color :content="getLegalKycPolitcs" />
    </div>
    <!-- new -->
    <fb-fut-button
      class="btn btn-fb-help w-100 text-start d-print-none"
      :class="{active: currentSlug === 'accounts_payments_bonus' || initialSlug === 'accounts_payments_bonus'}"
      data-bs-toggle="collapse"
    ...
    <div id="accounts_payments_bonus" class="collapse mb-2" :class="{ show: initialSlug === 'accounts_payments_bonus' }">
      ...
      <fut-html-render text-color :content="getLegalAccountsPaymentsBonus" />
    </div>
  </div>
</template>
<script>
