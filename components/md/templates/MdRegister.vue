    ...
    <section>
      ...
      <div class="register-form fut-scrollbar px-4 py-3">
        ...
        <form @submit.prevent="submitRegister()">
          ...
          <div v-if="currentSettings && !currentSettings.register_reduced" class="mb-2">
            <label
              for="userFirstName"
              class="form-label"
            >
          ...
          <div v-if="currentSettings && currentSettings.address_on_register" class="mb-2">
          ...
          <div v-if="currentSettings && !currentSettings.hide_username_on_register" class="mb-2">
