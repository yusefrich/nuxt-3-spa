    ...
    >
      <div class="col-markets-field">
        ...
        >
          ...
          <p v-if="getPreMatchSingleEvent && getPreMatchSingleEvent.league" class="mb-0">
...
import MdHeadingTitle from '@/components/md/molecules/MdHeadingTitle.vue'
import MdGameDetailList from '@/components/md/organisms/MdGameDetailList.vue'
