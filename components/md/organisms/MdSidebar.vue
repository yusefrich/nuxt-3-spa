<template>
  ...
  >
    ...
    >
      <n-link :to="localePath('/')" class="sidebar-brand transition">
        <img class="sidebar-logo ms-2" :class="{'sidebar-logo-color': currentSettings.background_logo === 1 || currentSettings.background_logo === null}" :src="currentSettings.logo" width="100%" alt="Logo">
      </n-link>
    ...
    <div class="sidebar-body transition">
      ...
      <div v-else class="body-wrapper">
        ...
        <ul class="games transition">
          ...
          >
            <n-link :to="localePath(`/sport/${league.sport_id}/league/${league.id}`)" class="league-item transition">
    ...
    navItems () {
      if (this.currentSettings.nav_bar && this.currentSettings.nav_bar.length) {
        ...
        return this.currentSettings.nav_bar.filter(item =>
          ...
          item.nav_link.replace(regex, '') !== '/casino/category/live' &&
