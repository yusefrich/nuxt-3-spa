<template>
  <div>
    <div v-if="league">
      <NuxtLink :to="localePath('/')" class="ms-3 px-0 go-back">
...
<script>
import MdGamesTableDesk from '@/components/md/molecules/MdGamesTableDesk.vue'
import MdGamesTableMobile from '@/components/md/molecules/MdGamesTableMobile.vue'
