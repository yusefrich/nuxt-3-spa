  ...
  <footer>
    <section class="general-links transition" :class="{accordion: width < 600}">
      <article :class="{'accordion-item': width < 600}">
        ...
        >
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=about')">
            {{ $t('i18n_quem_somos') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=responsible')">
            {{ $t('i18n_jogo_responsavel') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=privacy')">
            {{ $t('i18n_politica_de_privacidade') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=terms')">
            {{ $t('i18n_termos_e_condicoes') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=rules')">
            {{ $t('i18n_regras_gerais') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=aml')">
            {{ $t('i18n_politica_aml') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=deposits')">
            {{ $t('i18n_depositos_e_saques') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=cookies')">
            {{ $t('i18n_politica_de_cookies') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=kyc_politcs')">
            {{ $t('i18n_kyc_politcs') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=method_impartiality')">
            {{ $t('i18n_method_impartiality') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=accounts_payments_bonus')">
      ...
      <article :class="{'accordion-item': width < 600}">
        ...
        <div
          ...
          data-bs-parent="#accordionExample"
        >
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=faq')">
            {{ $t('i18n_faq') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=suport')">
            {{ $t('i18n_entre_em_contato') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=disputs_resolution')">
            {{ $t('i18n_disputs_resolution') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/help?slug=auto_exclusion')">
            {{ $t('i18n_auto_exclusion') }}
          </n-link>
          <n-link class="a transition text-decoration-none d-block" :to="localePath('/sobre-nos')">
            {{ $t('i18n_sobre_nos') }}
          </n-link>
          <a
            v-if="checkAfiliates"
