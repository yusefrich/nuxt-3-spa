        ...
        <div v-if="showProfileCard" class="menuProfile">
          ...
          <div class="text-center my-2">
            <div @click="showProfileCard = false">
              <n-link class="mb-0 btn-tab-menu border-green transition" :to="localePath('/user')">
          ...
          <div class="text-center my-2">
            <div @click="showProfileCard = false">
              <n-link class="mb-0 btn-tab-menu transition" :to="localePath('/user/my-account/documentos')">
                <div class="img-content">
          ...
          <div class="d-flex px-md-2 px-4 mb-2 justify-content-between">
            <n-link class="mb-0 btn-tab-menu me-1 transition" :to="localePath('/user/bank/saldo')">
            ...
            <n-link class="mb-0 btn-tab-menu ms-1 transition" :to="localePath('/user/bank/deposito?slug=withdraw')">
              <div class="d-flex" @click="showProfileCard = false">
                <div class="img-content">
          ...
          <div class="text-center">
            <div @click="showProfileCard = false">
              <n-link class="mb-0 btn-tab-menu transition" :to="localePath('/user/history/bets-resolvidas')">
                <div class="img-content">
