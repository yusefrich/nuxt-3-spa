  ...
  <sg-modal v-model="showCad" width="sm" custom-style="max-height: initial" close>
    ...
    <div class="px-4 register-container">
      <form @submit.prevent="submitRegister()">
        <div v-if="currentSettings && currentSettings.register_columns.includes('cpf')" class="d-flex">
        ...
        <div v-if="currentSettings && currentSettings.register_columns.includes('name')" class="content-input mt-3 d-flex justify-content-center align-items-center">
        ...
        <div v-if="currentSettings && currentSettings.register_columns.includes('last_name')" class="content-input mt-3 d-flex justify-content-center align-items-center">
          <img src="/Sg/Profile.png" alt="">
          <input
            id="last_name"
        ...
        <div v-if="currentSettings && currentSettings.register_columns.includes('birthdate')" id="birthdate" class="content-input mt-3" style="height: 80px">
        ...
        <div v-if="currentSettings && currentSettings.register_columns.includes('username')" class="content-input mt-3 d-flex justify-content-center align-items-center">
          <img src="/Sg/Profile.png" alt="">
          <input
            id="username"
        ...
        <div v-if="currentSettings && currentSettings.register_columns.includes('email')" class="content-input mt-3 d-flex justify-content-center align-items-center">
        ...
        <div v-if="currentSettings && currentSettings.register_columns.includes('phone')" class="content-input mt-3 d-flex justify-content-center align-items-center">
          <img src="/Sg/id-svgrepo-com.png" alt="">
          <input
            id="phone"
        ...
        <div v-if="currentSettings && currentSettings.register_columns.includes('zip')" class="content-input mt-3 d-flex justify-content-center align-items-center">
          <img src="/Sg/id-svgrepo-com.png" alt="">
          <input
            id="zip"
            v-model="payload.zip"
        ...
        <div class="content-input d-flex justify-content-center align-items-center mt-3">
          ...
          <input
            ...
            class="input"
            type="password"
            :placeholder="$t('i18n_crie_uma_senha')"
            required
          >
        ...
        <div class="content-input d-flex justify-content-center align-items-center">
          ...
          <input
            ...
            class="input"
            type="password"
            :placeholder="$t('i18n_confirme_a_senha')"
            required
          >
          <button class="border-0 bg-transparent me-2">
            <img src="/Sg/eye-svgrepo-com.png" alt="">
        ...
        <div v-if="currentSettings && currentSettings.register_columns.includes('ref')" class="content-input d-flex justify-content-center align-items-center mt-3">
        ...
        <div v-if="currentSettings && currentSettings.register_columns.includes('code_casino')" class="content-input d-flex justify-content-center align-items-center mt-3">
          <!-- <img class="ms-4" src="/Sg/password-svgrepo-com.png" alt=""> -->
          <input
            id="code_casino"
            v-model="payload.code_casino"
            class="input ms-4"
            type="text"
            :placeholder="$t('i18n_bonus_de_casino')"
            :readonly="readonly"
          >
        </div>
        <error-badge name="code_casino" :validate="errors?errors:{}" />
...
export default {
  ...
  mounted () {
    if (this.$route.query.ref || localStorage.getItem('ref')) {
      this.data.ref = this.$route.query.ref || localStorage.getItem('ref')
      this.readonly = true
    }

    if (this.$route.query.btag || localStorage.getItem('btag')) {
      this.payload.token = this.$route.query.btag || localStorage.getItem('btag')
      this.readonly = true
    }
