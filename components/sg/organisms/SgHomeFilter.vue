<template>
  <div>
    ...
    <div class="tabs-custom pb-4 mt-4">
      ...
      <a :href="localePath('/casino/category/mocked-most')" class=" ms-2 d-flex justify-content-center py-2 px-3 align-items-center button-menu transition text-decoration-none">
        <img class="me-2" width="15px" height="15px" src="/Sg/fire-w.png" alt="">
        <span>{{ $t('i18n_mais_jogados') }}</span>
      </a>
      <a :href="localePath('/casino/category/mocked-new')" class=" ms-2 d-flex justify-content-center py-2 px-3 align-items-center button-menu transition text-decoration-none">
