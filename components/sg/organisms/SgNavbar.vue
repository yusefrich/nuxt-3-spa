      ...
      <div v-if="user" class="d-flex w-75 justify-content-end align-items-center div-teste">
        ...
        <div class="d-md-flex d-none me-4">
          ...
          <div class="deposit-content d-flex">
            <NuxtLink :to="localePath('/user/bank/deposito')" class="d-flex mx-3 mb-0 align-items-center">
...
<script>
import SgProfileDropdown from '@/components/sg/molecules/SgProfileDropdown'
import SgModalLogin from '@/components/sg/molecules/SgModalLogin'
import SgModalForgotPassWord from '@/components/sg/molecules/SgModalForgotPassword'
import SgModalCreateAccount from '@/components/sg/molecules/SgModalCreateAccount'
import SgHighlight from '@/components/sg/organisms/SgHighlight'
import SgGameCardSm from '@/components/sg/atoms/SgGameCardSm'
