...
import SgGameCard from '@/components/sg/atoms/SgGameCard.vue'
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      getCasinoGame: 'casino/getCasinoGame',
      getCasinoMostPlayedGames: 'casino-featured/getCasinoMostPlayedGames',
      getCasinoNew: 'casino-featured/getCasinoNew', // sem chamada
      getCasinoCategoryGames: 'casino-category-games/getCasinoCategoryGames' // sem chamada
    })
  },
  mounted () {
  ...
  methods: {
    ...mapActions({
      fetchCasinoGamesByCategory: 'casino-category-games/fetchCasinoGamesByCategory', // sem chamada
      fetchCasinoMostPlayedGames: 'casino-featured/fetchCasinoMostPlayedGames', // sem chamada
      fetchCasinoNewGames: 'casino-featured/fetchCasinoNewGames', // sem chamada
