            ...
            <div class="container">
              ...
              <div v-if="step === 1">
                <div class="input-content-d py-2 d-flex align-items-center justify-content-center">
                  ...
                  <input v-mask="['###.###.###-##']" type="text" placeholder="000.000.080-00">
                </div>
              </div>
              <div v-if="step === 2">
                <div class="input-content-d py-2 d-flex align-items-center justify-content-center">
              ...
              <div v-if="step === 3">
                <div class="input-content-d py-2 d-flex align-items-center justify-content-center">
                  ...
                  <input v-mask="['###.###.###-##']" type="text" :placeholder="$t('i18n_digite_o_telefone_utilizado_na')">
                </div>
              </div>
              <div class="mt-4 mb-2">
...
import SgModalWithdraw from '@/components/sg/molecules/SgModalWithdraw'
