    ...
    <form @submit.prevent="submitRegister()">
      <div>
        ...
        <div class="px-5 py-1 bg-background register-content">
          ...
          <div v-if="currentSettings && currentSettings.register_columns.includes('cpf')" class="d-md-flex align-items-center mt-3 position-relative">
        ...
        <!-- Step - 2 -->
        <div class="px-5 py-1 bg-background register-content">
          <div v-if="currentSettings && currentSettings.register_columns.includes('name')" class="d-md-flex align-items-center mt-3">
          ...
          <div v-if="currentSettings && currentSettings.register_columns.includes('last_name')" class="d-md-flex align-items-center mt-3">
          ...
          <div
            v-if="currentSettings && currentSettings.register_columns.includes('birthdate')"
            id="birthdate"
        ...
        <div v-if="currentSettings && currentSettings.register_columns.includes('zip')" class="px-5 py-1 bg-background register-content">
        ...
        <!-- Step - 3 -->
        <div class="px-5 py-1 bg-background register-content">
          <div v-if="currentSettings && currentSettings.register_columns.includes('username')" class="d-md-flex align-items-center mt-3">
            <label class="label-controler d-none d-md-grid">
          ...
          <div v-if="currentSettings && currentSettings.register_columns.includes('email')" class="d-md-flex align-items-center mt-3">
          ...
          <div v-if="currentSettings && currentSettings.register_columns.includes('phone')" class="d-md-flex align-items-center mt-3">
          ...
          <div v-if="currentSettings && currentSettings.register_columns.includes('ref')" class="d-md-flex align-items-center mt-3">
            <label class="label-controler d-none d-md-grid">
          ...
          <div v-if="currentSettings && currentSettings.register_columns.includes('code_casino')" class="d-md-flex align-items-center mt-3">
            <label class="label-controler d-none d-md-grid">
              <span>{{ $t('i18n_bonus_de_casino') }}</span>
            </label>
            <label class="label-controler d-md-none w-100">
              <span>{{ $t('i18n_bonus_de_casino') }}</span>
            </label>
...
export default {
  ...
  mounted () {
    ...
    if (this.$route.query.btag || localStorage.getItem('btag')) {
      this.data.token = this.$route.query.btag || localStorage.getItem('btag')
      this.readonly = true
    }
