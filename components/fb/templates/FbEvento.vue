...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      getPreMatchEventLoading: 'pre-match-single-event/getPreMatchEventLoading',
  ...
  async mounted () {
    ...
    if (this.live) {
      ...
      console.log(this.getPreMatchSingleEvent)
      ...
      if (this.getPreMatchSingleEvent && this.getPreMatchSingleEvent.data && this.getPreMatchSingleEvent.data.action === 'redirect') {
        this.$router.push(this.localePath(`/sport/${this.$route.params.sportId}/aovivo/${this.getPreMatchSingleEvent.data.game_id}`))
      }
