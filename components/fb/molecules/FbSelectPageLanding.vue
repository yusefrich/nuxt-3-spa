  ...
  <div class="mobile-menu w-100 d-flex">
    ...
    <template v-if="sportsProvider === 'upgaming'">
      <div class="main-content">
        <fb-fut-button class="a menu-content" to="/virtuais">
          <div class="d-grid justify-content-center">
      ...
      <div class="main-content">
        <fb-fut-button class="a menu-content" to="/esports">
          <div class="d-grid justify-content-center">
            <!-- <img class="icon-size" src="/FbIcons/sports_live.png"> -->
            <img class="icon-size" src="/FbIcons/cassino_virtuais_2.svg">
          </div>
          <span class="mb-0 w-100 text-center d-inline-block">{{ $t('i18n_esports') }}</span>
        </fb-fut-button>
      </div>
    </template>
    <template v-else>
    ...
    <div v-if="(!applicationType('sports') || applicationType('casino')) && (landing_style === 'casino' || landing_style === 'default')" class="main-content">
...
export default {
  ...
  computed: {
    sportsProvider () {
      return process.env.SPORTS_PROVIDER
    },
