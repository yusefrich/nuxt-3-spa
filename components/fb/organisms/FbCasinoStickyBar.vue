      ...
      <div class="section-menu d-flex">
        ...
        <div id="scroller-sticky-bar-container" class="menu-container">
          <div class="menu-group">
            <div class="menu-item">
              <fb-fut-button class="a text-white fut-color-dynamic" :class="{active: currentCat === 'mocked-most'}" to="/casino?cat=mocked-most">
                {{ $t('i18n_populares') }}
              </fb-fut-button>
            </div>
            <div class="menu-item">
              <fb-fut-button class="a text-white fut-color-dynamic" :class="{active: currentCat === 'mocked-new'}" to="/casino?cat=mocked-new">
                {{ $t('i18n_lancamentos') }}
              </fb-fut-button>
            </div>
            <template v-for="(category, index) in categories" :key="'category_index_'+index">
              <div v-if="category.main" class="menu-item">
