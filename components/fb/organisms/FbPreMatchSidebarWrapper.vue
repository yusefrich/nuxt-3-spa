<template>
  <div>
    ...
    <div v-for="(league, index) in mainLeagues" :key="'main_league_'+index" class="container px-1">
      <fb-fut-button :to="'/sport/'+(league.sport_id ? league.sport_id : '6046')+'/league/'+league.id" class="main-league my-2">
