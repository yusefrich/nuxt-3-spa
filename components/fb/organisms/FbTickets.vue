    ...
    <div class="content-ticket d-none d-md-block d-print-block" :class="{'ticket-mobile-open': open}">
      ...
      <div class="bg-gray">
        ...
        <div class="container mobile-spacing-bottom pb-0 pb-md-1" :class="{'pb-1': tickets.length > 0}">
          ...
          <fb-fut-button
            v-if="errors && errors.message === 'Um ou mais eventos indisponíveis' && !awaysAccept"
...
export default {
  ...
  computed: {
    ...
    autoClean () {
      if (this.awaysAccept && this.errors && this.errors.message === 'Um ou mais eventos indisponíveis') {
        this.$emit('clearAll')
        this.closeTicket()
        return true
      }
