    ...
    <div class="row mx-0">
      <div class="col-lg-12">
        <div class="row m-0">
          ...
          <div v-if="live" class="col-soccer-field transition" :class="{'high': currentScroll > 40}">
            <inplay-heading-title
              :current-event="getInplaySingleEvent"
              class="d-none d-md-block"
            />
            <fut-inplay-field v-if="getInplaySingleEvent && getInplaySingleEvent.livescore_id && getStatscoreConfig" :id="getInplaySingleEvent.livescore_id" :statscore-config="getStatscoreConfig" />
