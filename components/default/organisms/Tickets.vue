            ...
            <div class="bets-content fut-scrollbar">
              ...
              <div v-if="multipleBetAvailable">
                ...
                <p class="text-white text-end fut-color-dynamic">
                  {{ $t('i18n_retorno_potencial') }} 12:  <span class="text-primary font-weigth-bold">{{ getMultipleTicketReturn > winMaxValue ? getFormattedValue(winMaxValue) : getFormattedValue(getMultipleTicketReturn) }}</span>
                </p>
              </div>
            </div>
            <label for="acceptance-checkbox" class="d-flex justify-content-end align-items-center">
              <span class="me-2 text-white">{{ $t('i18n_sempre_aceitar') }}</span>
              <input
...
import FutBetInput from '@/components/default/atoms/FutBetInput'
import FutBetField from '@/components/default/molecules/FutBetField'
