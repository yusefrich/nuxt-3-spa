    ...
    <div class="table-responsive" style="padding: 0px 1px">
      <table class="table" :class="{'mb-0': layout === 'oldBet365'}">
        <thead v-if="layout !== 'FB'">
          <tr>
            <th
              v-if="checkIfNames(getNames(rawOdds.odds))"
        ...
        >
          <tbody
            class="stripped"
            :class="layout === 'oldBet365' ? 'bet365-table-spacing' : ''"
          >
            <td
              v-if="name"
              style="max-width: 100px"
            ...
            <td
              ...
              :class="[
                ...
                {'fb-active' : (layout === 'FB') && hasSelected(getOddByNameAndHeader(rawOdds.odds, name, header).type)},
            ...
            >
              <template
                v-if="!getOddByNameAndHeader(rawOdds.odds, name, header).finished"
              >
                <div
                  class="p-0"
                  :class="{'d-flex m-1 mt-2 m-md-0 odd-flex-container': layout === 'FB'}"
                >
                  <div v-if="layout === 'FB'" class="fb-side-width" />
                  <span
                    v-if="layout === 'FB'" class=" text-start text-bet-header"
                  ...
                  >
                    <span
                      v-if="
                        getOddByNameAndHeader(rawOdds.odds, name, header).super_odd &&
                        getOddByNameAndHeader(rawOdds.odds, name, header).super_odd.slug === getOddByNameAndHeader(rawOdds.odds, name, header).type
                      "
                      :class="[{
                    ...
                    <span v-else class="position-relative ms-odd-3" :class="{'ms-odd-0': layout === 'FB'}">
                      <span style="vertical-align: middle">
                        <font-awesome-icon
                          v-if="getOddByNameAndHeader(rawOdds.odds, name, header).blocked"
                          class="text-white flash fut-color-dynamic"
                        ...
                        />
                        <font-awesome-icon
                          v-if="getOddByNameAndHeader(rawOdds.odds, name, header).leverage && getOddByNameAndHeader(rawOdds.odds, name, header).leverage === 'up'"
                        ...
                        />
                        <font-awesome-icon
                          v-if="getOddByNameAndHeader(rawOdds.odds, name, header).leverage && getOddByNameAndHeader(rawOdds.odds, name, header).leverage === 'down'"
