...
import SvgIcons from '@/components/default/atoms/SvgIcons'
...
export default {
  ...
  computed: {
    navItems () {
      const items = [
        { link: process.env.LANDING_ROUTE ? '/sports' : '/', text: this.$t('i18n_esporte', 2), icon: 'sport' },
        { link: '/sport/6046/aovivo', text: this.$t('i18n_esportes_ao_vivo'), icon: 'live' },
        { link: '/casino', text: this.$t('i18n_cassino'), icon: 'casino' },
        { link: '/casino-aovivo', text: this.$t('i18n_cassino_ao_vivo'), icon: 'money' },
