  ...
  computed: {
    ...
    dynamicGrid () {
      if (this.skContentWidth < 500 && this.width < 520) {
        ...
        return { columns: this.getSkOpenTicket ? 2 : 4, gap: '2rem 1rem' }
      } else if (this.skContentWidth < 1000 && this.width < 1300) {
        return { columns: this.getSkOpenTicket ? 3 : 5, gap: '2rem 1rem' }
      } else if (this.skContentWidth < 1150 && this.width < 1500) {
        return { columns: this.getSkOpenTicket ? 4 : 6, gap: '2rem 1rem' }
      }
