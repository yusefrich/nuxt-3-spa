<template>
  <div class="container">
    <div class="header">
      ...
      <div class="links">
        <n-link v-if="!isMobile" :to="localePath(`/sport/${currentSport}`)" class="link">
          {{ sports[currentSport] }}
        </n-link>
...
import SkOddsGenericCols from '@/components/sk/molecules/SkOddsGenericCols'
import SkOddsGenericList from '@/components/sk/molecules/SkOddsGenericList'
import SkOddsGenericTable from '@/components/sk/molecules/SkOddsGenericTable'
