          ...
          <div v-if="orderedItems" class="events">
            ...
            >
              ...
              >
                ...
                <div class="links">
                  <NuxtLink :to="localePath(`/sport/${value.sportId}`)" class="link transition">
                  ...
                  <font-awesome-icon class="icon" :icon="['fas', 'arrow-right']" />
                  <NuxtLink :to="localePath(`/sport/${value.sportId}/league/${value.leagueId}`)" class="link transition">
                    {{ key }}
                  </NuxtLink>
                </div>
              </div>
...
import SkCasinoCardGame from '@/components/sk/atoms/SkCasinoCardGame'
