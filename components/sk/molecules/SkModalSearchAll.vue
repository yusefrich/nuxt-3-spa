            ...
            <div v-if="orderedItems" class="events">
              ...
              >
                ...
                >
                  ...
                  <div class="links">
                    <n-link :to="localePath(`/sport/${val.sportId}`)" class="link transition">
                      {{ sportsList[selectedSport].name }}
                    </n-link>
                    <font-awesome-icon class="icon" :icon="['fas', 'arrow-right']" />
                    <n-link :to="localePath('/')" class="link transition">
                      <!--falta rota para filtro só de país -->
                      {{ val.country.name }}
                    </n-link>
                    <font-awesome-icon class="icon" :icon="['fas', 'arrow-right']" />
                    <n-link :to="localePath(`/sport/${val.sportId}/league/${val.leagueId}`)" class="link transition">
                      {{ key }}
                    </n-link>
                  </div>
                </div>
