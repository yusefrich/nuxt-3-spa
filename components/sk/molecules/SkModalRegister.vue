<template>
  ...
  >
    ...
    >
      ...
      <div>
        <div v-if="currentSettings && currentSettings.register_columns.includes('cpf')" class="document-wrapper">
          <sk-input
            v-model="documentRaw"
            :mask="['###.###.###-##']"
            type="tel"
        ...
        <error-badge
          ...
          class="error-badge"
        />
        <dir v-if="currentSettings && currentSettings.register_columns.includes('name')" class="p-0">
          <sk-input
        ...
        <dir v-if="currentSettings && currentSettings.register_columns.includes('last_name')" class="p-0">
          <sk-input
        ...
        <dir v-if="currentSettings && currentSettings.register_columns.includes('birthdate')" class="p-0 birthdate-wrapper">
        ...
        <dir v-if="currentSettings && currentSettings.register_columns.includes('country')" class="p-0 country-wrapper">
        ...
        <sk-input
          v-if="currentSettings && currentSettings.register_columns.includes('email')"
        ...
        />
        <sk-input
          v-if="currentSettings && currentSettings.register_columns.includes('phone')"
        ...
        <error-badge
          ...
          class="error-badge"
        />
        <div v-if="currentSettings && currentSettings.register_columns.includes('zip')" class="p-0">
          <sk-input
            v-model="zipRaw"
            :mask="['#####-###']"
            type="tel"
        ...
        <error-badge
          ...
          class="error-badge"
        />
        <div v-if="currentSettings && currentSettings.register_columns.includes('username')">
          <sk-input
        ...
        <label v-if="currentSettings && currentSettings.register_columns.includes('ref')" for="sk-input-code" class="w-100">
          <sk-checkbox
            v-model="code"
            class="mb-2"
            name="code"
        ...
        <sk-input
          v-if="code && currentSettings && currentSettings.register_columns.includes('ref')"
        ...
        />
        <sk-input
          v-if="currentSettings && !currentSettings.register_columns.includes('code_casino')"
          v-model="register.code_casino"
          name="code_casino"
          :label="$t('i18n_bonus_de_casino')"
          class="pb-4"
        />
        <error-badge
          name="code_casino"
...
export default {
  ...
  mounted () {
    ...
    if (this.$route.query.btag || localStorage.getItem('btag')) {
      this.register.token = this.$route.query.btag || localStorage.getItem('btag')
      this.readonly = true
    }
