  ...
  <div class="sk-leagues-table">
    ...
    >
      ...
      >
        ...
        <NuxtLink class="teams" :to="localePath(`/sport/${game.sport_id || eventsSport}/${live?'aovivo':'evento'}/${live?game.id:game.slug}`)">
          <span>
            {{ game.home_team }}
          </span>
        ...
        <div v-if="!isMobile" class="fixture-score">
          <div class="results">
            <div class="d-flex">
              <span v-if="(currentTime() - game.home_goal_real_time < 2000) && game.home_goal && (+game.sport_id === 6046 || +game.sport_id === 35709)" class="text-goal goal-flash me-1">GOL!!!</span>
              <span>
                {{ game.home_result }}
              </span>
            </div>
            <div class="d-flex">
              <span v-if="(currentTime() - game.away_goal_real_time < 2000) && game.away_goal && (+game.sport_id === 6046 || +game.sport_id === 35709)" class="text-goal goal-flash-2 me-1">GOL!!!</span>
              <span>
                {{ game.away_result }}
              </span>
            </div>
        ...
        <div class="market-count">
          <button @click="$router.push(localePath(`/sport/${game.sport_id || eventsSport}/${live?'aovivo':'evento'}/${live?game.id:game.slug}`))">
            +
          </button>
        </div>
      </div>
