              ...
              <div class="btn-wrapper">
                ...
                >
                  <div class="btn-cols-text">
                    ...
                    <div v-if="odd[index - 1] && !odd[index - 1].finished" class="second-text">
                      <div
                      ...
                      <span v-else class="position-relative ms-3 odd">
                        <span style="vertical-align: middle">
                          ...
                          <span
                            ...
                            class="leverage-down-arrow" style="vertical-align: middle"
                          >
                            <font-awesome-icon
                              class="flash-2"
                              style="font-size: 22px"
...
<script>
import SkOddsBtn from '@/components/sk/atoms/SkOddsBtn'
import windowWidth from '@/mixins.js/windowWidth.js'

export default {
  name: 'SkOddsGenericCols',
  components: {
    SkOddsBtn
  },
  mixins: [windowWidth],
