...
import SkSidebar from '@/components/sk/organisms/SkSidebar.vue'
import SkNavbar from '@/components/sk/organisms/SkNavbar.vue'
import SkTicket from '@/components/sk/organisms/SkTicket.vue'
import SkModalLogin from '@/components/sk/molecules/SkModalLogin.vue'
import SkModalForgotPassword from '@/components/sk/molecules/SkModalForgotPassword.vue'
import SkModalRegister from '~/components/sk/molecules/SkModalRegister.vue'
import SkFooter from '@/components/sk/organisms/SkFooter.vue'
import SkModalWallet from '@/components/sk/organisms/SkModalWallet.vue'
